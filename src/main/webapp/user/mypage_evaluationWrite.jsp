...
<script type="text/javascript">
    ...
    function EvaluationWrite(){
    	$.ajax({		
    		url : "${pageContext.request.contextPath}/user/mypage_evaluation.do",
    		type:'POST',
    		data :  $("#writeForm").serialize(),
    		success:function(data){
    			if(data == "success"){
    				alert("스터디 카페 후기가 등록되었습니다.^^");
    				location.href = "${pageContext.request.contextPath}/user/mypage_evaluationWrite.do?member_id=${sessionScope.loginUser.member_id}";
    			}
    			return false;
    		}
    	})
