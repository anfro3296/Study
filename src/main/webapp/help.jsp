...
<div class="wrapper">
    ...
    <div class="container content-sm">
	    <div class="col-md-9 col-md-offset-1">
		    <div class="headline"><h2>호스트 센터</h2></div>
	    </div>

	    <div class="row">
	    	<form role="form" action="help.do" name="search" method="get">
				...
				<c:if test="${!empty sessionScope.loginAdmin}">
			    	<div class="form-group col-md-1 col-md-offset-1">
			    		<input type="button" class="form-control" value="글쓰기" onclick="location.href='${pageContext.request.contextPath}/helpWrite.do' ">   	
					</div>			
				</c:if>	
	    	</form>
				...
				<table class="table table-hover" style="text-align: center;">
					...
					<c:forEach var="list" items="${list}">
						<tr>
							...
							<td width="63%" align="left"><a href="helpDetails.do?help_number=${list.help_number}">${list.help_title}</a></td>
