	                            	...
	                            	<c:forEach var="OrderList" items="${OrderList}">  
										   ...
										   <c:if test="${OrderList.reser_evaluationCheck=='YES'}">
		                                 	  <td width="13%"><input type="button" class="btn-u btn-u-sm btn-u-green" value="작성 완료" disabled"></td>
										  	  <td width="14%"><input type="button" class="btn-u btn-u-sm btn-u-green" value="작성 하러 가기 " onclick="location.href='${pageContext.request.contextPath}/cafe_evaluationReplyWrite.do?reser_number=${OrderList.reser_number}' "></td>
										   </c:if>
		                                   </tr>
	                                </c:forEach>
	                            </tbody>
