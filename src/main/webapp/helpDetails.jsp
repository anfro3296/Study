    ...
    <div class="row">
    	<div class="col-md-10 col-md-offset-1">
			<table class="table" style="text-align: center;">
				<thead > 
					<tr class="active">
							<th colspan="3"	style="background-color: #eeeeee; text-align: center;"><font color="black" size="5pt">공지사항 보기</font></th>
					</tr>
				</thead>
					<tbody>
						<tr>
						...
						<tr>
							...
							<td colspan="2" style="min-height: 200px; text-align: left;"><p style="white-space: pre-line; background:#F0FFF0"><font color="black" size="3pt">${help.help_content}</font></p></td>
						</tr>
					</tbody>
			</table>
			
			<div class="col-md-2 col-md-offset-6">
				<input type="button" class="btn-u btn-block btn-u-green" value="목록" onclick="location.href='${pageContext.request.contextPath}/help.do' ">   	
			</div>
			<c:if test="${!empty sessionScope.loginAdmin}">
				<div class="col-md-2">
					<input type="button" class="btn-u btn-block btn-u-green" value="수정" onclick="location.href='${pageContext.request.contextPath}/helpUpdate.do?help_number=${help.help_number}' ">
				</div>		
				<div class="col-md-2">
...
<script type="text/javascript">
	...
	function del(help_number) {
		...
		if (chk) {
			location.href='helpDelete.do?help_number='+help_number;
		}
	}
