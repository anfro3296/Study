			...
			<form method="post" action="page_mypage_evaluationWrite.do" id="writeForm" >
				...
				<input type="hidden" name="reser_number" value="${memberOrder.reser_number}">
				 ...
				 <div class="col-md-2">
				  ...
				  <div class="col-md-2">
					   	 <input type="button" class="btn-u btn-block btn-u-green" value="목록" onclick="location.href='${pageContext.request.contextPath}/page_mypage_orderEvaluation.do?member_id=${sessionScope.loginUser.member_id}' ">   	
				  </div>
			  </form>
		</div>
	</div>
