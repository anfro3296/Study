...
<div class="wrapper">
    ...
    <div class="container content-sm">
	    ...
	    <div class="row">
	    	<form role="form" action="notice/list.do" name="search" method="get">
				...
				<c:if test="${!empty sessionScope.loginAdmin}">
			    	<div class="form-group col-md-1 col-md-offset-1">
			    		<input type="button" class="form-control" value="글쓰기" onclick="location.href='${pageContext.request.contextPath}/notice/write.do' ">   	
					</div>			
				</c:if>	
	    	</form>
	    	...
	    	<div class="col-md-10 col-md-offset-1">
				<table class="table table-hover" style="text-align: center;">
					...
					<c:forEach var="list" items="${list}">
						<tr>
							<td width="10%">공지사항</td>
							<td width="63%" align="left"><a href="${pageContext.request.contextPath}/notice/details.do?notice_number=${list.notice_number}">${list.notice_title}</a></td>
